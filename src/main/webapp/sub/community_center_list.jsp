                    ...
                    <div id="board" class="clearfix">
                        ...
                        <table class="p_table">
                            ...
                            <tbody class="tb_text">
                                <tr>
                                    <td>15</td>
                                    <td class="p_sub"><a href="community_center_view.jsp">2025년 상반기 영등포본동 자치회관 운영결과 보고서</a></td>
                                    <td>영등포본동</td>
                                ...
                                <tr>
                                    <td>14</td>
                                    <td class="p_sub"><a href="community_center_view.jsp">2024년 상반기 영등포본동 자치회관 운영결과 보고서</a></td>
                                    <td>영등포본동</td>
                        ...
                        <div class="board_btm_btns">
                            <a href="community_center_write.jsp" class="btn btn_write">글쓰기</a>
                        </div>
                    </div>
                    <!-- //contents -->
