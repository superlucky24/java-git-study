                ...
                <main>
                    ...
                    <div class="contents">
                        <div class="board_write">
                            ...
                            <form action="complaintwrite.do" method="post" onreset="clearForm(this)">
                                <table class="table_form">
                                    <caption class="blind">민원신청 게시판 글쓰기</caption>
                                    <colgroup>
                                        <col class="col1">
                                        <col class="col2">
                                    </colgroup>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="comTitle" id="comTitle" class="input form_input" maxlength="300" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">
                                            ...
                                            <td>
                                                <textarea name="comcontent" id="comcontent" class="input" rows="10" maxlength="4000" required></textarea>
                                            </td>
                                        </tr>
                                        <tr>
